...
from .filters import is_class_d, is_declared_message, is_detected_user, is_high_score_user, is_watch_user, is_wb_text
...
def terminate_user(client: Client, message: Message, context: str) -> bool:
    ...
    try:
        ...
        elif is_detected_user(message) or uid in glovar.recorded_ids[gid] or the_time == "true":
            delete_message(client, gid, mid)
