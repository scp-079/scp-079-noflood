...
from .. import glovar
from .etc import code, code_block, general_link, get_forward_name, get_full_name, lang, message_link
...
def forward_evidence(client: Client, message: Message, level: str, rule: str, the_time: str, the_count: str,
    ...
    try:
        ...
        if the_time and the_count:
            freq_text = f"{the_time} {lang('seconds')} {the_count} {lang('messages')}"
            text += f"{lang('message_freq')}{lang('colon')}{code(freq_text)}\n"
